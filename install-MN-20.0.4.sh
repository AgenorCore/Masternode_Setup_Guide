...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='agenor.conf'
CONFIGFOLDER='/root/.agenor'
COIN_DAEMON='agenord'
COIN_CLI='agenor-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AgenorCore/Agenor/releases/download/v1.0.0/agenor-1.0.0-ubuntu20.04-daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='agenord'
COIN_EXPLORER='http://agenor.network/'
COIN_PORT=31052
RPC_PORT=32051
